...
The ramaining columns (66 in total) are all numeric and correspond to the average by activity and subject of the following measured features, as described in the source files “features_info.txt”:
